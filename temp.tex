...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{chidori.png}
  \caption{CHIDORI}
  \label{fig:zmp}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{Default_Algo_CoM_ZMP_Foot.png}
  \includegraphics[width=0.4\linewidth]{UseAlgorithm_Algo_CoM_ZMP_Foot.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{com_planned (1).png}
  \caption{アルゴリズム適用前後でのCoM$_y$とZMP$_y$の比較}
  \label{fig:comzmp}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{com_roll (1).png}
