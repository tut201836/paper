...
\input{control-overview/overview}

\input{control-overview/com-control}

\input{control-overview/zmp-control}

\input{control-overview/lipm-control}

\input{control-overview/admitance}

\input{control-overview/control_flow}

\input{control-overview/position-of-reseach}