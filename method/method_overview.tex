...
LIPM では，重心高さを一定値 $z_{\mathrm{c}}$ と仮定し，角運動量の影響を無視することで，CoM と ZMP の関係は次式で表される（$y$ 軸方向）．
\begin{equation}
...
片脚支持期における二足歩行ロボットのロール方向挙動は，支持脚足先を支点とした倒立振り子運動として近似的に捉えることができる．ここでは，CoM を質点とし，支点から CoM までの距離を $\ell$ とする単純な振り子モデルを用いて，CoM 高さが転倒挙動に与える影響を力学的に考察する．
